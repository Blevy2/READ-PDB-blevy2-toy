...
Pop <- init_pop_Bens(sim_init = sim, Bio = c("spp1" = 1e5, "spp2" = 2e5), #these values from paper 
...
moveCov[["spp_tol"]] <- list("spp1" = list("mu" = 12, "va" = 8),
				                               "spp2" = list("mu" = 15, "va" = 9) )
...
surv_random <- BENS_init_survey(sim_init = sim,design = 'random_station', n_stations = 40, #this is total per year (10 in each of 4 strata)
...
#load data from Mars
load("/net/home5/blevy/Bens_R_Projects/READ-PDB-blevy2-toy/20 year moveCov matrices/Final/Test_Mars.RData")
...
nCoresToUse <- 3  #one less than I have
