...
#no fishing
fleets <- init_fleet(sim_init = sim, VPT = list("spp1" = 1, "spp2" = 1), #VPT = value per ton
...
surv_random <- BENS_init_survey(sim_init = sim,design = 'random_station', n_stations = 49, start_day = 1, stations_per_day = 7, Qs = c("spp1" = 0.1, "spp2"= 0.2), strata_coords = hab$strata, strata_num = hab$stratas )
