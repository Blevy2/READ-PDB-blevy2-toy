...
sim <- init_sim(nrows = 90, ncols = 110, n_years = 2, n_tows_day = 4,
...
hab <- BENS_create_hab(sim_init = sim, 
		  ...
		  strata = list(                              #Form: upper left, upper right, lower left, lower right
				     "strata1" = c(0,sim$idx[["nrows"]]/2,0,sim$idx[["ncols"]]/2),   #of the form  c(x1, x2, y1, y2) THESE ARE BOUNDARIES OF MATRIX VALUES
				      
				      "strata2" = c(0,sim$idx[["nrows"]]/2,sim$idx[["ncols"]]/2+1,sim$idx[["ncols"]]),
				     
				     	"strata3" = c(sim$idx[["nrows"]]/2 + 1,sim$idx[["nrows"]], 0 ,sim$idx[["ncols"]]/2),
...
plot_spatiotemp_hab(hab = hab, moveCov = moveCov, spwn_wk = list("spp1" = 4:8, "spp2" = 4:8), plot.file =  "C:/Users/benjamin.levy/Desktop/Github/READ-PDB-blevy2-toy/testfolder")
...
surv_random <- BENS_init_survey(sim_init = sim,design = 'random_station', n_stations = 50, start_day = 1, stations_per_day = 5, Qs = c("spp1" = 0.1, "spp2"= 0.2))
