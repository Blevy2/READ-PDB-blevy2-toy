...
# #use below for n_years = 3 
# surv_random <- BENS_init_survey(sim_init = sim,design = 'random_station', n_stations = 60, start_day = 1, stations_per_day = 5, Qs = c("spp1" = 0.1, "spp2"= 0.2), strata_coords = hab$strata, strata_num = hab$stratas )

#use below for n_years = 2

#use below for 3 years
...
p1 <- plot_pop_summary(results = res,
		 timestep = "annual",
		 save = TRUE, 
		 save.location = "testfolder"
		 )

plot_pop_summary(results = res, timestep = "daily", save = TRUE, save.location = "testfolder")
p1
...
p8 <- plot_spatiotemp_hab(hab = hab, moveCov = moveCov, spwn_wk = list("spp1" = 4:8, "spp2" = 4:8), plot.file =  "testfolder")



#plotting habitat and spawning habitat
